        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center">
          <div className="relative w-full max-w-[420px] group">
            ...
            <div className="relative rounded-2xl bg-[#0c1017] border border-slate-800/90 shadow-2xl overflow-hidden p-3.5 backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between px-2 pb-3 pt-1 border-b border-slate-800/80">
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-pulse" />
                  <span className="text-xs font-mono font-semibold text-slate-200 tracking-tight">
                    Aymen Gasmi • Portrait
                  </span>
                </div>
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 text-[11px] font-mono text-cyan-300 bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 rounded-md transition-colors"
                    title="Upload or change portrait image"
                  >
                    <Camera className="w-3 h-3" />
                    <span>{showPhotoControls ? 'Close' : 'Update Photo'}</span>
                  </button>
                </div>
              </div>

              {/* Photo Customizer Drawer if opened */}
              {showPhotoControls && (
                <div className="p-3 my-2 bg-slate-900/95 border border-cyan-500/30 rounded-xl space-y-2.5 text-xs animate-in fade-in duration-200">
                  <div className="flex items-center justify-between text-slate-300 font-medium">
                    <span className="flex items-center gap-1 text-cyan-300">
                      <Sparkles className="w-3.5 h-3.5" />
                      Set Your Personal Photo
                    </span>
                    <button
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 py-2 px-3 bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-200 border border-cyan-500/40 rounded-lg font-medium transition-colors"
                    >
                  ...
                  <div className="flex gap-1.5 pt-1">
                    <input
                      ...
                      className="flex-1 px-2.5 py-1.5 text-xs bg-slate-950 border border-slate-700 rounded-md text-slate-200 placeholder-slate-500 focus:outline-none focus:border-cyan-400"
                    />
                    <button
                      onClick={handleApplyUrl}
                      className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-md font-medium border border-slate-700 transition-colors"
                    >
                      Apply
                    </button>
                  </div>
